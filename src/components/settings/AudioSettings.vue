...
export default class extends Vue {
  filters: string[] = []
  filtersDescriptions = {
    HighPassFilter: 'High-Pass Filter passes frequencies above its cutoff frequency and attenuates frequencies below its cutoff frequency',
    LowPassFilter:
    ...
    Compressor: 'A compressor has the ability to reduce the difference in order for the quiet notes to be louder and the peak notes to be quieter',
    Delay: 'A delay effect is similar to an echo, in that the sound is repeated one or more times after the original sound',
    PingPongDelay: 'Ping Pong Delay is a time-sensitive delay that pans the delay to the left and right speakers one after the other',
    Chorus: 'An equal mix of the wet and dry signal is used with the wet signal being delayed and pitch modulated'
  }
